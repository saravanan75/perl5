#my %re_cc = (
 #       'American Express'  => qr/^3[47][0-9]{13}$/,
  ...
  #     'MasterCard'        => qr/^(?:5[1-5][0-9]{2}|222[1-9]|22[3-9][0-9]|2[3-6][0-9]{2}|27[01][0-9]|2720)[0-9]{12}$/,
   ...
   # C:\Perl\module8>h2xs -AX -n Fileutil
   #copy the module to the lib directory
#);
...
print $writefile, "\n";
Fileutil::log("Starting the process");
sub print_footer{
	my $currtime = localtime();
	my $username = $_[0];
	my $footer = "This program was run at $currtime by $username";
	$footer;
}
